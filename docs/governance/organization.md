...
- [Governance overview](./overview.md): How decisions are made
- [Voting system](./voting-system.md): Proposal voting
- [Moderation](./moderation.md): Content policies
