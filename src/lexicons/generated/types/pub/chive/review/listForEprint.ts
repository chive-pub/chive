...
const is$typed = _is$typed,
  validate = _validate;
const id = 'pub.chive.review.listForEprint';
...
export interface ReviewView {
  $type?: 'pub.chive.review.listForEprint#reviewView';
  /** Review AT-URI */
  uri: string;
  /** Content identifier */
  cid: string;
...
export interface AuthorRef {
  $type?: 'pub.chive.review.listForEprint#authorRef';
  did: string;
  handle?: string;
  displayName?: string;
  avatar?: string;
...
export interface AnnotationBody {
  $type?: 'pub.chive.review.listForEprint#annotationBody';
  /** Plain text content */
  text: string;
...
export interface RichTextFacet {
  $type?: 'pub.chive.review.listForEprint#richTextFacet';
  index: ByteSlice;
...
export interface ByteSlice {
  $type?: 'pub.chive.review.listForEprint#byteSlice';
  byteStart: number;
  byteEnd: number;
}
...
export interface MentionFacet {
  $type?: 'pub.chive.review.listForEprint#mentionFacet';
...
export interface TagFacet {
  $type?: 'pub.chive.review.listForEprint#tagFacet';
...
export interface TextSpanTarget {
  $type?: 'pub.chive.review.listForEprint#textSpanTarget';
  /** Eprint AT-URI */
  source: string;
...
export interface TextQuoteSelector {
  $type?: 'pub.chive.review.listForEprint#textQuoteSelector';
...
export interface TextPositionSelector {
  $type?: 'pub.chive.review.listForEprint#textPositionSelector';
