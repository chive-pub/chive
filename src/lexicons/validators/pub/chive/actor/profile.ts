...
export const actorProfileSchema = z.object({
  ...
  affiliations: z.array(z.object({ name: z.string().max(200), rorId: z.string().max(50).optional() })).max(10).optional(),
  fields: z.array(z.string()).max(20).optional(),
  nameVariants: z.array(z.string().max(200)).max(20).optional(),
  previousAffiliations: z.array(z.object({ name: z.string().max(200), rorId: z.string().max(50).optional() })).max(20).optional(),
  researchKeywords: z.array(z.object({ label: z.string().max(100), fastId: z.string().max(20).optional(), wikidataId: z.string().max(20).optional() })).max(50).optional(),
