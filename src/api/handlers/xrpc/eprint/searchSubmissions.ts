...
// expandFieldsWithNarrower, flattenHierarchy, and HierarchyNode are now
// in src/utils/field-expansion.ts for reuse by getTrending and other handlers.
...
export const searchSubmissions: XRPCMethod<QueryParams, void, OutputSchema> = {
  ...
  handler: async ({ params, c }): Promise<XRPCResponse<OutputSchema>> => {
    ...
    const searchQuery = {
      ...
      sort: params.sort === 'recent' ? ('recent' as const) : undefined,
      filters: {
