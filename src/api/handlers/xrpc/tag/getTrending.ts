...
import type {
  QueryParams,
  OutputSchema,
} from '../../../../lexicons/generated/types/pub/chive/tag/getTrending.js';
import type { UserTag } from '../../../../storage/neo4j/types.js';
import type { XRPCMethod, XRPCResponse } from '../../../xrpc/types.js';

/**
 * XRPC method for pub.chive.tag.getTrending.
 *
 * @public
 */
export const getTrending: XRPCMethod<QueryParams, void, OutputSchema> = {
  ...
  handler: async ({ params, c }): Promise<XRPCResponse<OutputSchema>> => {
    ...
    type ServiceTimeWindow = 'day' | 'week' | 'month';
    ...
    try {
      trendingTags = await tagManager.getTrendingTags(limit, {
        timeWindow: params.timeWindow as ServiceTimeWindow | undefined,
