...
import type { EprintVersion } from '@/lib/api/schema';

/**
 * Props for the EprintVersionSelector component.
 */
export interface EprintVersionSelectorProps {
...
/**
 * Dropdown selector for switching between eprint versions.
 *
 * @remarks
 ...
 */
export function EprintVersionSelector({
  versions,
  currentVersion,
  onVersionChange,
  className,
...
/**
 * Props for the EprintVersionTimeline component.
 */
export interface EprintVersionTimelineProps {
  /** Array of version data */
  versions: EprintVersion[];
  /** Currently selected version number */
  currentVersion?: number;
...
/**
 * Visual timeline display of eprint versions.
 *
 * @remarks
 ...
 * ```
 */
export function EprintVersionTimeline({
  versions,
  currentVersion,
  onVersionClick,
  className,
