...
import { PreprintAbstract, StaticAbstract } from './preprint-abstract';

describe('PreprintAbstract', () => {
  ...
  it('renders full text when below maxLength', () => {
    render(<PreprintAbstract abstract={shortAbstract} />);
  ...
  it('truncates long abstracts', () => {
    render(<PreprintAbstract abstract={longAbstract} maxLength={50} />);
  ...
  it('respects defaultExpanded prop', () => {
    render(<PreprintAbstract abstract={longAbstract} maxLength={50} defaultExpanded />);
  ...
  it('applies custom className', () => {
    render(<PreprintAbstract abstract={shortAbstract} className="custom-abstract-class" />);
    const container = screen.getByText(shortAbstract).closest('section');
    expect(container).toHaveClass('custom-abstract-class');
  });

  it('respects custom maxLength', () => {
    render(<PreprintAbstract abstract={longAbstract} maxLength={100} />);
