...
describe('PDFTextSelectionHandler', () => {
  ...
  describe('W3C selector generation', () => {
    ...
    it('uses preprintUri as source', () => {
      const onSelect = vi.fn();
      const preprintUri = 'at://did:plc:test/pub.chive.preprint.submission/xyz';
      ...
      render(
        <PDFTextSelectionHandler {...defaultProps} preprintUri={preprintUri} onSelect={onSelect}>
