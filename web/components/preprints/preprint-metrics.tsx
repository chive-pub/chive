...
import type { PreprintMetrics as PreprintMetricsType } from '@/lib/api/schema';

/**
 * Props for the PreprintMetrics component.
 */
export interface PreprintMetricsProps {
  /** Metrics data */
  metrics?: PreprintMetricsType;
  /** Display size */
  size?: 'sm' | 'default' | 'lg';
...
/**
 * Displays preprint engagement metrics (views, downloads, endorsements).
 *
 * @remarks
 ...
 */
export function PreprintMetrics({
  metrics,
  size = 'default',
  showAll = false,
  className,
}: PreprintMetricsProps) {
  if (!metrics) {
    return null;
  }
