...
const is$typed = _is$typed,
  validate = _validate;
const id = 'pub.chive.review.getThread';
...
export interface ReviewView {
  $type?: 'pub.chive.review.getThread#reviewView';
  /** Review AT-URI */
  uri: string;
  /** Content identifier */
  cid: string;
...
export interface AuthorRef {
  $type?: 'pub.chive.review.getThread#authorRef';
  did: string;
  handle?: string;
  displayName?: string;
  avatar?: string;
...
export interface AnnotationBody {
  $type?: 'pub.chive.review.getThread#annotationBody';
  /** Plain text content */
  text: string;
...
export interface RichTextFacet {
  $type?: 'pub.chive.review.getThread#richTextFacet';
  index: ByteSlice;
...
export interface ByteSlice {
  $type?: 'pub.chive.review.getThread#byteSlice';
  byteStart: number;
  byteEnd: number;
}
...
export interface MentionFacet {
  $type?: 'pub.chive.review.getThread#mentionFacet';
...
export interface LinkFacet {
  $type?: 'pub.chive.review.getThread#linkFacet';
...
export interface TagFacet {
  $type?: 'pub.chive.review.getThread#tagFacet';
...
export interface TextSpanTarget {
  $type?: 'pub.chive.review.getThread#textSpanTarget';
  /** Eprint AT-URI */
  source: string;
...
export interface TextQuoteSelector {
  $type?: 'pub.chive.review.getThread#textQuoteSelector';
...
export interface TextPositionSelector {
  $type?: 'pub.chive.review.getThread#textPositionSelector';
